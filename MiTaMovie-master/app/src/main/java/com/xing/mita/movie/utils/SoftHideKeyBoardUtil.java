        ...
        if (usableHeightNow != usableHeightPrevious) {
            ...
            if (heightDifference > (usableHeightSansKeyboard / 4)) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                    frameLayoutParams.height = usableHeightSansKeyboard - heightDifference + statusBarHeight + 7;
                } else {
                    frameLayoutParams.height = usableHeightSansKeyboard - heightDifference + 7;
                }
...
//                }
    ...
    public static void showOrHideKeyBoard(Activity activity, boolean show) {
        activity.getWindow().setSoftInputMode(show ? WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE :
     ...
     * @param et      EditText
     */
    public static void forceHideKeyBoard(Context context, EditText et) {
        InputMethodManager imm = (InputMethodManager) context.getSystemService(Context.INPUT_METHOD_SERVICE);
        //强制隐藏键盘
