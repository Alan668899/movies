...
public class CacheVideoAdapter extends BaseQuickAdapter<LocalVideo, BaseViewHolder> {

    public CacheVideoAdapter(int layoutResId, @Nullable List<LocalVideo> data) {
