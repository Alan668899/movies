...
import com.xing.mita.movie.upnp.ui.UpnpActivity;
 ...
 * @Description 视频详情页
 */
public class AaqqVideoPlayActivity extends BaseActivity implements
    ...
    @OnClick({R.id.ifv_back, R.id.tv_video_name, R.id.tv_origin_tip, R.id.ifv_share,
            R.id.ifv_download, R.id.ifv_collect, R.id.ifv_x5, R.id.ifv_tv})
    public void click(View v) {
        switch (v.getId()) {
            ...
            case R.id.ifv_share:
                ...
                intent.putExtra("source", Constant.SOURCE_AAQQY);
            ...
            case R.id.ifv_tv:
                intent = new Intent();
                intent.putExtra("url", finalUrl);
                startWithIntent(UpnpActivity.class, intent);
                break;
    ...
    private void getHtml() {
        ...
        String url = baseUrl + originUrl;
        Log.w(TAG, "getHtml: " + url);
        ...
        Element detailElement = doc.select("div.vod-n-l").first();
        if (detailElement != null) {
            name = detailElement.select("h1").text();

            Elements statusElements = detailElement.select("p");
            ...
            intro = detailElement.select("em").last().text();
            if (TextUtils.isEmpty(intro) || intro.length() < 4) {
                intro = "";
            }
        }
        ...
        for (int i = 0; i < contentSize; i++) {
            ...
            for (Element element : elements) {
                list.add(new Episode(element.attr("href"),
                        element.attr("title")));
            }
    ...
    private VideoAllCallBack playStateListener = new GSYSampleCallBack() {
        ...
        public void onPrepared(String url, Object... objects) {
            ...
            mIfvTv.setVisibility(View.VISIBLE);
            //显示可以下载
        ...
        public void onAutoComplete(String url, Object... objects) {
            ...
            if (position < 0) {
                ...
                videoPlayer.loadCoverImage(imgUrl);
                if (ScreenUtils.getScreenIsLand(AaqqVideoPlayActivity.this)) {
    ...
    private void saveHistory() {
        ...
        history.setName(name)
                .setWebSite(Constant.SOURCE_AAQQY)
    ...
    private void loadHtml(String url) {
        ...
        mIfvTv.setVisibility(View.GONE);
        //隐藏可以下载
